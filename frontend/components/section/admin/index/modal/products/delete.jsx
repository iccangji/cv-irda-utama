...
const DeleteProductModal = ({ product, onClose, onSuccess }) => {
    ...
    const handleDeleteData = async () => {
        ...
        try {
            ...
            const response = await axios.delete(`${process.env.NEXT_PUBLIC_BACKEND_URL}/api/products/${product.id}`, {
                headers: {
    ...
    return (
        <div
            className="fixed top-50 left-0 right-0 z-50 items-center justify-center w-full p-4 overflow-x-hidden overflow-y-hidden inset-0 h-[calc(100%-1rem)] min-h-full bg-gray-900 bg-opacity-50 flex"
        >
            ...
            <div className="relative w-full max-w-2xl max-h-full">
                <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div className="p-4 space-y-6 text-gray-900 dark:text-white">
                        ...
                        <div className="mt-0">Hapus {product.name} dari data produk?</div>
                    </div >
